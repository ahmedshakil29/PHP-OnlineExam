                ...
                <nav class=" d-none d-md-block bg-light sidebar">
                    <div class="sidebar-sticky">
                        <ul class="nav flex-column">
                            ...
                            <li class="nav-item">
                                <a class="nav-link btn btn-info mb-2" href="Feedback.php?q=3&SectionID=<?php echo ($SectionID) ?> ">
                                    Feedback
                                </a>
                            </li>
                            <li class="nav-item">
                        ...
                        if (@$_GET['q'] == 0) {
                            ...
                            while ($row = mysqli_fetch_array($result)) {
                                ...
                                '<tr>
                                        ...
                                        <td><b><a href="Ranking.php?eid=' . $quizID . '&SectionID=' . $SectionID . '" class="pull-right btn sub1" style="margin:0px;background:#99cc32"><span class="glyphicon glyphicon-eye-open" aria-hidden="true"></span>&nbsp;<span class="title1"><b>Mark</b></span></a></b></td>
                                        <td><b><a href="remove_Quiz.php?q=rmquiz&eid=' . $quizID . '" class="pull-right btn sub1" style="margin:0px;background:red"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span>&nbsp;<span class="title1"><b>Remove</b></span></a></b></td>
                                        </tr>';
                                // } else {
                                // echo
