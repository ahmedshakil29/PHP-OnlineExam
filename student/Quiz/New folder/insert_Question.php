...
if (@$_GET['q'] == 'addqns') {
    ...
    for ($i = 1; $i <= $n; $i++) {
        ...
        $qb = mysqli_query($con, "INSERT INTO options VALUES  ('" . $QuestionID . "','" . $obid . "','" . $b . "')") or die('Error62');
        $qc = mysqli_query($con, "INSERT INTO options VALUES  ('" . $QuestionID . "','" . $ocid . "','" . $c . "')") or die('Error63');
        $qd = mysqli_query($con, "INSERT INTO options VALUES  ('" . $QuestionID . "','" . $odid . "','" . $d . "')") or die('Error64');
        $e = $_POST['ans' . $i];
        switch ($e) {
            case 'a':
                $ansid = $oaid;
